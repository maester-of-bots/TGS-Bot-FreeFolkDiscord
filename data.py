...
Get PRAW stuff from https://old.reddit.com/prefs/apps/

Webhook is for Discord notifications

Keywords are what make the bot respond

Subs is just FreeFolkSimulator

db needs to be the name this bot's table was initialized as, see SQL for details.

Put quotes in qoutes.

Super easy.

"bot_username": {
        "reddit": praw.Reddit(
                    client_id=os.getenv("botname_client_id"),
                    client_secret=os.getenv("botname_client_secret"),
                    password=os.getenv("botname_password"),
                    user_agent=os.getenv("botname_user_agent"),
                    username=os.getenv("botname_username")
                ),
        "webhook": os.getenv("botname_webhook"),
